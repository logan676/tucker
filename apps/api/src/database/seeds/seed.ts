...
// Brisbane QUT area locations
const brisbaneLocs = [
  { lat: -27.4771, lng: 153.0286, address: '2 George St, Brisbane City QLD 4000', district: 'QUT Gardens Point' },
  { lat: -27.4698, lng: 153.0251, address: '123 Queen St Mall, Brisbane QLD 4000', district: 'Brisbane CBD' },
  { lat: -27.4705, lng: 153.0235, address: '45 Edward St, Brisbane QLD 4000', district: 'Brisbane CBD' },
  { lat: -27.4621, lng: 153.0332, address: '78 Fortitude Valley QLD 4006', district: 'Fortitude Valley' },
  { lat: -27.4785, lng: 153.0380, address: '156 Eagle St, Brisbane QLD 4000', district: 'Eagle Street' },
  { lat: -27.4731, lng: 153.0177, address: '234 Roma St, Brisbane QLD 4000', district: 'Roma Street' },
  { lat: -27.4812, lng: 153.0289, address: '89 Grey St, South Brisbane QLD 4101', district: 'South Bank' },
  { lat: -27.4839, lng: 153.0235, address: '167 Melbourne St, South Brisbane QLD 4101', district: 'South Brisbane' },
  { lat: -27.4665, lng: 153.0412, address: '42 James St, Fortitude Valley QLD 4006', district: 'James Street' },
  { lat: -27.4589, lng: 153.0356, address: '321 Brunswick St, Fortitude Valley QLD 4006', district: 'Brunswick Street Mall' },
  { lat: -27.4725, lng: 153.0298, address: '55 Elizabeth St, Brisbane QLD 4000', district: 'Brisbane CBD' },
  { lat: -27.4756, lng: 153.0222, address: '12 Albert St, Brisbane QLD 4000', district: 'Brisbane CBD' },
  { lat: -27.4803, lng: 153.0341, address: '98 Stanley St, South Brisbane QLD 4101', district: 'South Bank' },
  { lat: -27.4645, lng: 153.0289, address: '27 Wickham St, Fortitude Valley QLD 4006', district: 'Chinatown' },
  { lat: -27.4688, lng: 153.0198, address: '143 Mary St, Brisbane QLD 4000', district: 'Brisbane CBD' },
];
...
const merchants = [
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[0].district,
    address: brisbaneLocs[0].address,
    longitude: brisbaneLocs[0].lng,
    latitude: brisbaneLocs[0].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[1].district,
    address: brisbaneLocs[1].address,
    longitude: brisbaneLocs[1].lng,
    latitude: brisbaneLocs[1].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[2].district,
    address: brisbaneLocs[2].address,
    longitude: brisbaneLocs[2].lng,
    latitude: brisbaneLocs[2].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[3].district,
    address: brisbaneLocs[3].address,
    longitude: brisbaneLocs[3].lng,
    latitude: brisbaneLocs[3].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[4].district,
    address: brisbaneLocs[4].address,
    longitude: brisbaneLocs[4].lng,
    latitude: brisbaneLocs[4].lat,
    features: ['Dine-in', 'Delivery', 'Takeaway'],
    status: MerchantStatus.ACTIVE,
    isOpen: true,
    categoryIndex: 8,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[5].district,
    address: brisbaneLocs[5].address,
    longitude: brisbaneLocs[5].lng,
    latitude: brisbaneLocs[5].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[6].district,
    address: brisbaneLocs[6].address,
    longitude: brisbaneLocs[6].lng,
    latitude: brisbaneLocs[6].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[7].district,
    address: brisbaneLocs[7].address,
    longitude: brisbaneLocs[7].lng,
    latitude: brisbaneLocs[7].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[8].district,
    address: brisbaneLocs[8].address,
    longitude: brisbaneLocs[8].lng,
    latitude: brisbaneLocs[8].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[9].district,
    address: brisbaneLocs[9].address,
    longitude: brisbaneLocs[9].lng,
    latitude: brisbaneLocs[9].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[10].district,
    address: brisbaneLocs[10].address,
    longitude: brisbaneLocs[10].lng,
    latitude: brisbaneLocs[10].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[11].district,
    address: brisbaneLocs[11].address,
    longitude: brisbaneLocs[11].lng,
    latitude: brisbaneLocs[11].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[12].district,
    address: brisbaneLocs[12].address,
    longitude: brisbaneLocs[12].lng,
    latitude: brisbaneLocs[12].lat,
    features: ['Delivery', 'Takeaway', 'Customizable'],
    status: MerchantStatus.ACTIVE,
    isOpen: true,
    categoryIndex: 7,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[13].district,
    address: brisbaneLocs[13].address,
    longitude: brisbaneLocs[13].lng,
    latitude: brisbaneLocs[13].lat,
  ...
  },
  {
    ...
    province: 'Queensland',
    city: 'Brisbane',
    district: brisbaneLocs[14].district,
    address: brisbaneLocs[14].address,
    longitude: brisbaneLocs[14].lng,
    latitude: brisbaneLocs[14].lat,
...
// Banners data - Australian market
const banners = [
  {
    title: 'Welcome to Tucker!',
  ...
  },
  {
    ...
    subtitle: 'No delivery fee on orders over $25',
  ...
  },
  {
    ...
    actionValue: 'summer-sale',
    sortOrder: 3,
  },
  {
    title: 'Weekend Brunch',
    subtitle: 'Brisbane\'s best brunch spots',
  ...
  {
    title: 'Healthy Eats',
    subtitle: 'Fresh salads, poke bowls & more',
  ...
  {
    title: 'Sweet Treats',
    subtitle: 'Desserts, gelato & pastries',
  ...
  {
    title: 'Date Night',
    subtitle: 'Romantic dinner packages for two',
...
// Coupons data - Australian market (AUD)
const coupons = [
  {
    code: 'WELCOME10',
    name: 'Welcome Offer',
  ...
  },
  {
    ...
    description: '$8 off weekend orders over $35',
    discountType: DiscountType.FIXED,
    discountValue: 8,
    minOrderAmount: 35,
    totalLimit: 200,
  ...
  },
  {
    code: 'LUNCH20',
    name: 'Lunch Deal',
    description: '20% off lunch orders (11am-2pm)',
    discountType: DiscountType.PERCENTAGE,
    discountValue: 20,
    minOrderAmount: 20,
    maxDiscount: 15,
  ...
  },
  {
    code: 'BRISBANE',
    name: 'Brisbane Local',
    description: '$5 off for Brisbane locals',
    discountType: DiscountType.FIXED,
    discountValue: 5,
    minOrderAmount: 25,
    totalLimit: 500,
...
export async function seed(dataSource: DataSource) {
  ...
  // Create or find test users for reviews
  console.log('Creating test users for reviews...');
  const testUsers: User[] = [];
  for (let i = 0; i < 10; i++) {
    const phone = `1380000${1000 + i}`;
